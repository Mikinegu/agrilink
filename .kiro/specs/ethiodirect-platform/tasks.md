...
- [x] 1. Create AuthGuard, RoleGuard, and LoadingSpinner
...
- [x] 2. Create DynamicSidebar and DashboardLayout
...
- [x] 3. Create AppRouter and update App.tsx
...
- [x] 4. Create LandingPageRoute, LoginPage, and NotFoundPage
...
- [x] 5. Update EthioDirectRegistration for router integration
...
- [x] 6. Create Farmer Dashboard pages
...
- [x] 7. Create Buyer Dashboard pages
...
- [x] 8. Create Logistics Dashboard pages
...
- [x] 9. Create Flask AI sidecar service
...
- [x] 10. Add Node.js proxy routes to server.ts
...
- [x] 11. Create Supabase IoT weight logs migration
...
- [x] 12. TypeScript verification and integration smoke test
